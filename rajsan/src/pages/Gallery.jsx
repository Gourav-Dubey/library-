...
const GalleryPage = () => {
  ...
  // Library photos
  const libraryImages = [
    { id: 1, src: "library1.webp", title: "Study Zone", description: "Quiet study areas with comfortable seating" },
    { id: 2, src: "library2.webp", title: "Reading Area", description: "Cozy reading corners with natural light" },
    { id: 3, src: "library3.webp", title: "Group Study", description: "Spaces for collaborative learning" },
    { id: 4, src: "library4.webp", title: "Book Collection", description: "Vast collection of academic resources" },
    { id: 5, src: "library5.webp", title: "Digital Hub", description: "Modern technology for digital learning" },
    { id: 6, src: "library6.webp", title: "Study Carrels", description: "Private study spaces for focused learning" },
    { id: 7, src: "library7.webp", title: "Reading Lounge", description: "Comfortable lounge areas for reading" },
    { id: 8, src: "library8.webp", title: "Discussion Room", description: "Meeting rooms for group discussions" },
    { id: 9, src: "library9.webp", title: "Rare Books Section", description: "Special collection of rare books" },
    { id: 10, src: "library10.webp", title: "Computer Lab", description: "Computer workstations for research" },
    { id: 11, src: "library11.webp", title: "Silent Study Area", description: "Absolute silence for concentration" },
    { id: 12, src: "library12.webp", title: "Magazine Section", description: "Latest magazines and periodicals" },
    { id: 13, src: "library13.webp", title: "Magazine ", description: "Latest magazines " },
    { id: 14, src: "library14.webp", title: "Magazine Section", description: "Latest magazines and periodicals" },
    { id: 15, src: "library15.webp", title: "Magazine Section", description: "Latest magazines and periodicals" },
    { id: 16, src: "library16.webp", title: "Magazine Section", description: "Latest magazines and periodicals" },
    { id: 17, src: "library17.webp", title: "Magazine Section", description: "Latest magazines and periodicals" },
    { id: 18, src: "library18.webp", title: "Magazine Section", description: "Latest magazines and periodicals" },
  ];
