    ...
    <div className="min-h-screen bg-gray-900 text-white pt-16 px-4">
      ...
      >
        ...
        <div className="bg-gray-800/50 rounded-2xl p-4 md:p-6 border border-gray-700">
          <div className="aspect-video bg-gray-700 rounded-xl flex items-center justify-center border border-gray-600">
            <div className="text-center">
              <MapPin className="w-12 h-12 text-blue-400 mx-auto mb-3" />
              <h3 className="text-lg md:text-xl font-bold text-white mb-2">RajSan Library</h3>
              <p className="text-gray-300 text-sm mb-4 max-w-xs">
                Behlot Bypass Road, Ganj Basoda
              </p>
              <a
                href="https://maps.google.com"
                className="inline-flex items-center gap-2 bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 md:px-6 md:py-3 rounded-lg font-medium transition-all text-sm md:text-base"
              >
